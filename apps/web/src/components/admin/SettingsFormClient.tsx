  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card className="p-6">
        ...
        {/* Business Days */}
        <div className="mt-4">
          <label className="mb-2 block text-sm font-medium text-gray-600">Business Days</label>
              ...
              <button
                ...
                className={`rounded-lg px-3 py-2 text-xs font-medium capitalize transition ${
                  form.businessDays.includes(day)
                    ...
                    : "bg-luxury-card text-gray-400 border border-luxury-border hover:text-gray-600"
                }`}
              >
                {day.slice(0, 3)}
              </button>
