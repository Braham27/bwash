    ...
    <>
      ...
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} title="Add Testimonial">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Star Rating */}
          <div>
            <label className="mb-1.5 block text-sm font-medium text-foreground/70">Rating</label>
                ...
                >
                  <Star
                    className={`h-6 w-6 transition ${
                      star <= form.rating ? "text-gold fill-gold" : "text-foreground/20"
                    }`}
                  />
                </button>
              ))}
          ...
          <div>
            <label htmlFor="comment" className="mb-1.5 block text-sm font-medium text-foreground/70">
              Comment *
            </label>
            <textarea
              id="comment"
