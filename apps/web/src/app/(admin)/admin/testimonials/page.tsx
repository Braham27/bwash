    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Manage customer reviews for the website</p>
        </div>
                ...
                allTestimonials.map((t) => (
                  <TableRow key={t.id}>
                    <TableCell>
                      ...
                      {t.vehicleType && (
                        <p className="text-xs text-gray-400">{t.vehicleType}</p>
                      )}
                    </TableCell>
                    <TableCell>
                        ...
                        {Array.from({ length: 5 }).map((_, i) => (
                          <Star
                            ...
                            className={`h-3.5 w-3.5 ${
                              i < t.rating ? "text-gold fill-gold" : "text-gray-200"
                            }`}
                          />
                        ))}
                      </div>
