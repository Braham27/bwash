...
const navItems = [
  { href: "/staff", icon: LayoutDashboard, label: "My Jobs" },
  { href: "/staff/schedule", icon: Calendar, label: "Schedule" },
  { href: "/staff/history", icon: Clock, label: "History" },
];
  ...
  return (
    <aside className="hidden lg:flex h-full w-64 flex-col border-r border-luxury-border bg-luxury-card">
      <div className="flex h-16 items-center gap-2 px-6 border-b border-luxury-border">
        ...
        <span className="text-xs text-foreground/30 uppercase tracking-wider">Staff</span>
      </div>
