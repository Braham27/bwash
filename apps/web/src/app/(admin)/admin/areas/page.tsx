    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-foreground/50">Manage operational zones and zip codes</p>
        </div>
        <AreaFormClient />
      </div>
              ...
              {areas.length === 0 ? (
                ...
                areas.map((area) => (
                  <TableRow key={area.id}>
                    ...
                    <TableCell className="text-sm text-foreground/60">{area.city}</TableCell>
                    <TableCell className="text-sm text-foreground/60">{area.state}</TableCell>
                    <TableCell>
