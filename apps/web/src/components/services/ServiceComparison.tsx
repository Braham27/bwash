            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-luxury-border bg-luxury-gray/50">
                  <th className="px-6 py-4 text-left text-foreground/70 font-medium">
                    Feature
                  </th>
                  <th className="px-6 py-4 text-center text-foreground/70 font-medium">
                    Basic
                  </th>
              ...
              <tbody className="divide-y divide-luxury-border">
                {features.map((f) => (
                  ...
                  >
                    <td className="px-6 py-3.5 text-foreground/80">{f.name}</td>
